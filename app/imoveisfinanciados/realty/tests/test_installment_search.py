...
class InstallmentSearchGetValid(SimulatorBaseTest, RealtyBaseTest, TestCase):

    def setUp(self):
        super(InstallmentSearchGetValid, self).setUp()
        self.target = reverse('realty:installment_search',
                              kwargs={'state': 'br'})
        data = {
            'state': '1',
            'city': '1',
